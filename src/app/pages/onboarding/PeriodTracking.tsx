    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-3xl">Do you track your periods?</h1>
          <p className="text-muted-foreground">
            This helps us provide better cycle predictions
          </p>
        </div>
        ...
        <div className="space-y-4">
          <button
            ...
            className={`w-full bg-card border-2 rounded-2xl p-6 text-left transition-all hover:border-primary ${
              tracks === true ? 'border-primary bg-primary/5' : 'border-border'
            }`}
          >
            <div className="flex items-center justify-between">
              <div>
                <h3 className="mb-1">Yes, I track my periods</h3>
          ...
          <button
            ...
            className={`w-full bg-card border-2 rounded-2xl p-6 text-left transition-all hover:border-primary ${
              tracks === false ? 'border-primary bg-primary/5' : 'border-border'
            }`}
          >
            <div className="flex items-center justify-between">
              <div>
                <h3 className="mb-1">No, I don't track</h3>
                <p className="text-sm text-muted-foreground">
