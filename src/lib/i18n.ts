...
const en = {
  ...
  paywall: {
    ...
    features: { chart: 'Complete birth chart analysis', transits: 'Daily AI transit predictions', cycle: 'Period cycle tracking & forecasting', hormonal: 'Hormonal pattern insights', moon: 'Moon phase integration', wellness: 'Personalized wellness tips', unlimited: 'Unlimited chart access' },
  },
  auth: {
 ...
 landing: { heroLine1: 'Your Cycle,', heroLine2: 'Your Stars', feature1Title: 'Full Birth Chart', feature1Desc: 'Complete astrological analysis based on your exact birth time and location', feature2Title: 'Transit Insights', feature2Desc: 'Understand how current planetary movements affect your cycle and wellness', feature3Title: 'Smart Tracking', feature3Desc: 'Period and symptom tracking combined with astrological timing', subCta: 'Get started with your personalized cosmic wellness journey' },
  ...
  emptyBody: 'We\'ll notify you about your cycle, transits, and daily insights',
  markAllRead: 'Mark all as read',
  periodSoonTitle: '🔴 Period due soon',
  periodSoonBody: 'Your period is expected in {{days}} days · {{date}}',
  periodToday: 'Your period may start today. Take it easy 💙',
  ovulationTitle: '🌕 Ovulation window',
  ovulationSoon: 'Your ovulation window opens in {{days}} days',
  ovulationToday: 'You may be ovulating today — peak fertility',
  ovulationPeak: 'You are in your peak ovulation window',
  phaseChangeTitle: '✨ New cycle phase',
  phaseChangeBody: 'You have entered your {{phase}} today',
  predictionsTitle: '🔮 Daily insights ready',
  predictionsBody: '{{count}} new cosmic insights are waiting for you',
  predictionsEmpty: 'Tap to generate your daily cosmic insights',
  transitsTitle: '⭐ {{count}} active transits',
  transitsBody: '{{aspect}} and more are affecting your chart today',
  transitsBodyGeneric: 'Current planetary movements are affecting your chart',
},
...
const fr: typeof en = {
 ...
 landing: { heroLine1: 'Votre cycle,', heroLine2: 'Vos étoiles', feature1Title: 'Thème natal complet', feature1Desc: 'Analyse astrologique complète basée sur votre heure et lieu de naissance exacts', feature2Title: 'Insights de transits', feature2Desc: 'Comprenez comment les mouvements planétaires actuels affectent votre cycle', feature3Title: 'Suivi intelligent', feature3Desc: 'Suivi du cycle combiné avec le timing astrologique', subCta: 'Commencez votre voyage cosmique personnalisé' },
  ...
  emptyBody: 'Nous vous informerons de votre cycle, des transits et des insights quotidiens',
  markAllRead: 'Tout marquer comme lu',
  periodSoonTitle: '🔴 Règles bientôt',
  periodSoonBody: 'Vos règles sont attendues dans {{days}} jours · {{date}}',
  periodToday: 'Vos règles pourraient commencer aujourd\'hui. Prenez soin de vous 💙',
  ovulationTitle: '🌕 Fenêtre d\'ovulation',
  ovulationSoon: 'Votre fenêtre d\'ovulation s\'ouvre dans {{days}} jours',
  ovulationToday: 'Vous pourriez ovuler aujourd\'hui — fertilité maximale',
  ovulationPeak: 'Vous êtes dans votre fenêtre d\'ovulation maximale',
  phaseChangeTitle: '✨ Nouvelle phase du cycle',
  phaseChangeBody: 'Vous êtes entrée dans votre {{phase}} aujourd\'hui',
  predictionsTitle: '🔮 Insights quotidiens prêts',
  predictionsBody: '{{count}} nouveaux insights cosmiques vous attendent',
  predictionsEmpty: 'Appuyez pour générer vos insights cosmiques quotidiens',
  transitsTitle: '⭐ {{count}} transits actifs',
  transitsBody: '{{aspect}} et plus affectent votre thème aujourd\'hui',
  transitsBodyGeneric: 'Les mouvements planétaires actuels affectent votre thème',
},
...
landing: { heroLine1: 'Ihr Zyklus,', heroLine2: 'Ihre Sterne', feature1Title: 'Vollständiges Geburtshoroskop', feature1Desc: 'Vollständige astrologische Analyse basierend auf Ihrer genauen Geburtszeit und dem Geburtsort', feature2Title: 'Transiteinblicke', feature2Desc: 'Verstehen Sie, wie aktuelle Planetenbewegungen Ihren Zyklus beeinflussen', feature3Title: 'Intelligentes Tracking', feature3Desc: 'Periodentracking kombiniert mit astrologischem Timing', subCta: 'Beginnen Sie Ihre personalisierte kosmische Wellness-Reise' },
  ...
  emptyBody: 'Wir benachrichtigen Sie über Ihren Zyklus, Transite und tägliche Einblicke',
  markAllRead: 'Alle als gelesen markieren',
  periodSoonTitle: '🔴 Periode bald fällig',
  periodSoonBody: 'Ihre Periode wird in {{days}} Tagen erwartet · {{date}}',
  periodToday: 'Ihre Periode könnte heute beginnen. Schonen Sie sich 💙',
  ovulationTitle: '🌕 Ovulationsfenster',
  ovulationSoon: 'Ihr Ovulationsfenster öffnet sich in {{days}} Tagen',
  ovulationToday: 'Sie könnten heute ovulieren — maximale Fruchtbarkeit',
  ovulationPeak: 'Sie befinden sich in Ihrem Hauptovulationsfenster',
  phaseChangeTitle: '✨ Neue Zyklusphase',
  phaseChangeBody: 'Sie haben heute Ihre {{phase}} begonnen',
  predictionsTitle: '🔮 Tägliche Einblicke bereit',
  predictionsBody: '{{count}} neue kosmische Einblicke warten auf Sie',
  predictionsEmpty: 'Tippen Sie, um Ihre täglichen kosmischen Einblicke zu generieren',
  transitsTitle: '⭐ {{count}} aktive Transite',
  transitsBody: '{{aspect}} und mehr beeinflussen heute Ihr Horoskop',
  transitsBodyGeneric: 'Aktuelle Planetenbewegungen beeinflussen Ihr Horoskop',
},
...
landing: { heroLine1: 'Tu ciclo,', heroLine2: 'Tus estrellas', feature1Title: 'Carta natal completa', feature1Desc: 'Análisis astrológico completo basado en tu hora y lugar de nacimiento exactos', feature2Title: 'Insights de tránsitos', feature2Desc: 'Entiende cómo los movimientos planetarios actuales afectan tu ciclo', feature3Title: 'Seguimiento inteligente', feature3Desc: 'Seguimiento del ciclo combinado con el timing astrológico', subCta: 'Comienza tu viaje cósmico personalizado' },
  ...
  emptyBody: 'Te notificaremos sobre tu ciclo, tránsitos e insights diarios',
  markAllRead: 'Marcar todo como leído',
  periodSoonTitle: '🔴 Período próximo',
  periodSoonBody: 'Tu período se espera en {{days}} días · {{date}}',
  periodToday: 'Tu período podría comenzar hoy. Cuídate 💙',
  ovulationTitle: '🌕 Ventana de ovulación',
  ovulationSoon: 'Tu ventana de ovulación se abre en {{days}} días',
  ovulationToday: 'Podrías estar ovulando hoy — máxima fertilidad',
  ovulationPeak: 'Estás en tu ventana de ovulación máxima',
  phaseChangeTitle: '✨ Nueva fase del ciclo',
  phaseChangeBody: 'Has entrado en tu {{phase}} hoy',
  predictionsTitle: '🔮 Insights diarios listos',
  predictionsBody: '{{count}} nuevos insights cósmicos te esperan',
  predictionsEmpty: 'Toca para generar tus insights cósmicos diarios',
  transitsTitle: '⭐ {{count}} tránsitos activos',
  transitsBody: '{{aspect}} y más afectan tu carta hoy',
  transitsBodyGeneric: 'Los movimientos planetarios actuales afectan tu carta',
},
...
landing: { heroLine1: 'Seu ciclo,', heroLine2: 'Suas estrelas', feature1Title: 'Mapa natal completo', feature1Desc: 'Análise astrológica completa baseada na sua hora e local de nascimento exatos', feature2Title: 'Insights de trânsitos', feature2Desc: 'Entenda como os movimentos planetários atuais afetam seu ciclo', feature3Title: 'Rastreamento inteligente', feature3Desc: 'Acompanhamento do ciclo combinado com timing astrológico', subCta: 'Comece sua jornada cósmica personalizada' },
  ...
  emptyBody: 'Vamos notificá-la sobre seu ciclo, trânsitos e insights diários',
  markAllRead: 'Marcar tudo como lido',
  periodSoonTitle: '🔴 Período em breve',
  periodSoonBody: 'Seu período é esperado em {{days}} dias · {{date}}',
  periodToday: 'Seu período pode começar hoje. Cuide-se 💙',
  ovulationTitle: '🌕 Janela de ovulação',
  ovulationSoon: 'Sua janela de ovulação abre em {{days}} dias',
  ovulationToday: 'Você pode estar ovulando hoje — fertilidade máxima',
  ovulationPeak: 'Você está na sua janela de ovulação máxima',
  phaseChangeTitle: '✨ Nova fase do ciclo',
  phaseChangeBody: 'Você entrou na sua {{phase}} hoje',
  predictionsTitle: '🔮 Insights diários prontos',
  predictionsBody: '{{count}} novos insights cósmicos esperam por você',
  predictionsEmpty: 'Toque para gerar seus insights cósmicos diários',
  transitsTitle: '⭐ {{count}} trânsitos ativos',
  transitsBody: '{{aspect}} e mais estão afetando seu mapa hoje',
  transitsBodyGeneric: 'Os movimentos planetários atuais afetam seu mapa',
}, 
